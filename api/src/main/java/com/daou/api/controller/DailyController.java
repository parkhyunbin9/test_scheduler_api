...
public class DailyController {
	...
	@ApiOperation(value = "일별 신규 유저", notes = "조회시간 기준 일별 신규 유저")
	...
	public CommonResponse hourlyNewUserList(@Validated @ModelAttribute SearchConditionDto condition,
		...
		Page<DailyResponseDto.DailyNewUser> newUserList = dailyService.getDailyNewUser(condition, pageable);
	...
	@ApiOperation(value = "일별 이탈 유저", notes = "조회시간 기준 일별 이탈 유저")
	...
	public CommonResponse hourlyChurnUserList(@Validated @ModelAttribute SearchConditionDto condition,
		...
		Page<DailyResponseDto.DailyChurnUser> churnUserList = dailyService.getDailyChurnUser(condition, pageable);
	...
	@ApiOperation(value = "일별 신규 매출", notes = "조회시간 기준 일별 매출")
	...
	public CommonResponse hourlyPayAmountUserList(@Validated @ModelAttribute SearchConditionDto condition,
		...
		Page<DailyResponseDto.DailyPayAmount> payAmountList = dailyService.getDailyPayAmount(condition, pageable);
	...
	@ApiOperation(value = "일별 비용", notes = "조회시간 기준 일별 비용")
	...
	public CommonResponse hourlyCostList(@Validated @ModelAttribute SearchConditionDto condition, Pageable pageable) {
		...
		Page<DailyResponseDto.DailyCost> costList = dailyService.getDailyCost(condition, pageable);
	...
	@ApiOperation(value = "일별 판매 금액", notes = "조회시간 기준 일별 판매 금액")
	...
	public CommonResponse hourlySalesAmountList(@Validated @ModelAttribute SearchConditionDto condition,
		Pageable pageable) {
		Page<DailyResponseDto.DailySalesAmount> salesAmountList = dailyService.getDailySalesAmount(condition,
			pageable);
