...
public class HourlyDataRepositoryImpl extends QuerydslRepositorySupport implements HourlyDataRepositoryCustom {
    ...
    @Override
    public Page<HourlyResponseDto.HourlyNewUser> findHourlyNewUserWithConditions(SearchConditionDto condition, Pageable pageable) {
    ...
    @Override
    public Page<HourlyResponseDto.HourlyChurnUser> findHourlyChurnUserWithConditions(SearchConditionDto condition , Pageable pageable) {
    ...
    @Override
    public Page<HourlyResponseDto.HourlyPayAmount> findHourlyPayAmountWithConditions(SearchConditionDto condition, Pageable pageable) {
    ...
    @Override
    public Page<HourlyResponseDto.HourlyCost> findHourlyCostWithConditions(SearchConditionDto condition, Pageable pageable) {
    ...
    @Override
    public Page<HourlyResponseDto.HourlySalesAmount> findHourlySalesAmountWithConditions(SearchConditionDto condition, Pageable pageable) {
    ...
    @Override
    public Page<DailyResponseDto.DailyNewUser> findDailyNewUserWithConditions(SearchConditionDto condition, Pageable pageable) {
    ...
    @Override
    public Page<DailyResponseDto.DailyChurnUser> findDailyChurnUserWithConditions(SearchConditionDto condition, Pageable pageable) {
    ...
    @Override
    public Page<DailyResponseDto.DailyPayAmount> findDailyPayAmountWithConditions(SearchConditionDto condition, Pageable pageable) {
    ...
    @Override
    public Page<DailyResponseDto.DailyCost> findDailyCostWithConditions(SearchConditionDto condition, Pageable pageable) {
    ...
    @Override
    public Page<DailyResponseDto.DailySalesAmount> findDailySalesAmountWithConditions(SearchConditionDto condition, Pageable pageable) {
    ...
    private BooleanExpression dateEq(SearchConditionDto condition) {
        return (Objects.nonNull(condition.getDate()) && condition.getDate().isBefore(LocalDate.now())) ? hourlyData.date.eq(condition.getDate()) : null;
    }

    private BooleanExpression dateGoe(SearchConditionDto condition) {
        return (Objects.nonNull(condition.getStartDate()) && condition.getStartDate().isBefore(LocalDate.now())) ? hourlyData.date.goe(condition.getStartDate()) : null;
    }

    private BooleanExpression dateLoe(SearchConditionDto condition) {
        return (Objects.nonNull(condition.getEndDate()) && condition.getEndDate().isBefore(LocalDate.now())) ? hourlyData.date.loe(condition.getEndDate()) : null;
    }
